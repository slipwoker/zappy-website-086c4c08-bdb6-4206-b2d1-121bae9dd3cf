document.addEventListener('DOMContentLoaded', function () {
  ...
  const OBSERVE_SELECTOR = '.fade-in, [data-animate]';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '086c4c08-bdb6-4206-b2d1-121bae9dd3cf',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '086c4c08-bdb6-4206-b2d1-121bae9dd3cf';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '086c4c08-bdb6-4206-b2d1-121bae9dd3cf';
